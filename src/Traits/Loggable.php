...
namespace Billiemead\LaravelActivityLog\Traits;
...
trait Loggable
{
    ...
    {
        if (!auth()->check() || $model->excludeLogging || !config('activity-log.activated', true)) return;
    ...
    {
        if (config('activity-log.log_events.on_edit', false)) {
